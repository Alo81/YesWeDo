...
namespace SmashUltimateEditor
{
    ...
    {   
        ...
        /*
        public static Dictionary<string, string> UNLOCKABLE_FIGHTERS = new Dictionary<string, string>() 
        {
            {"mario",    "ui_chara_mario"},
            {"luigi",   "ui_chara_luigi"},
            {"peach",   "ui_chara_peach"},
            {"daisy", "ui_chara_daisy"},
            {"bowser",   "ui_chara_koopa"},
            {"dr_mario",   "ui_chara_mariod"},
            {"rosalina_and_luma",   "ui_chara_daisy"},
            {"dedede",  "ui_chara_rosetta"},
            {"bowser_jr",   "ui_chara_koopajr"},
            {"donkey_kong",   "ui_chara_donkey"},
            {"diddy_kong",  "ui_chara_diddy"},
            {"king_k_rool",   "ui_chara_krool"},
            {"link_bow", "ui_chara_link"},
            {"zelda",   "ui_chara_zelda"},
            {"sheik",   "ui_chara_sheik"},
            {"ganondorf", "ui_chara_ganon"},
            {"young_link",    "ui_chara_younglink"},
            {"toon_link", "ui_chara_toonlink"},
            {"samus", "ui_chara_samus"},
            {"dark_samus", "ui_chara_samusd"},
            {"zerosuit_samus",    "ui_chara_szerosuit"},
            {"ridley",   "ui_chara_ridley"},
            {"yoshi", "ui_chara_yoshi"},
            {"kirby",   "ui_chara_kirby"},
            {"meta_knight",   "ui_chara_metaknight"},
            {"dedede", "ui_chara_dedede"},
            {"fox_mccloud",   "ui_chara_fox"},
            {"falco_lombardi",    "ui_chara_falco"},
            {"littlemac",   "____"},
            {"lucario", "____"},
            {"lucas",   "____"},
            {"lucina",  "____"},
