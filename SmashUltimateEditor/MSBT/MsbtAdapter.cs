...
namespace YesWeDo.MSBT
{
    ...
    public class MsbtEntry : TextEntry
    {
        // Interface
        public string Name
        {
        ...
        public bool isSpirit
        {
            get
            {
                return !Name.Equals(SpiritBattleId);
            }
        }
        ...
        public string GetSpiritBattleIdIfSpirirt()
        {
            return isSpirit? SpiritBattleId : null;
        }
        #endregion
    }
}